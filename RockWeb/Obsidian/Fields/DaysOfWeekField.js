System.register(["vue", "./Index", "../Elements/CheckBoxList", "../Services/Number"], function (exports_1, context_1) {
    "use strict";
            ...
            exports_1("default", Index_1.registerFieldType(fieldTypeGuid, vue_1.defineComponent({
                ...
                computed: {
                    displayValue: function () {
                        ...
                        return this.options()
                            .filter(function (v) { return _this.internalValue.indexOf(v.value) !== -1; })
                ...
                watch: {
                    internalValue: function () {
                        this.$emit('update:modelValue', this.internalValue.sort(function (a, b) { return Number_1.toNumber(a) - Number_1.toNumber(b); }).join(","));
                    },
                    modelValue: {
                        immediate: true,
                        handler: function () {
